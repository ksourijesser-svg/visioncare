...
class User(Base):
    ...
    bio = Column(Text, nullable=True)              # doctor's short presentation — shown to patients
    google_maps_url = Column(String, nullable=True)  # doctor's Google Maps place link — patients open reviews
