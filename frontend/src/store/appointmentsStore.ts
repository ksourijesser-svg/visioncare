...
const INITIAL_APPOINTMENTS: Appointment[] = [
  { id: 1, patient_id: 1, patient_nom: 'Martin', patient_prenom: 'Sophie', patient_telephone: '06 12 34 56 78', date: '2026-06-18', heure: '09:00', duree: 30, motif: 'Bilan visuel annuel', statut: 'complete', notes: '' },
  { id: 2, patient_id: 2, patient_nom: 'Dubois', patient_prenom: 'Pierre', patient_telephone: '06 98 76 54 32', date: '2026-06-18', heure: '09:30', duree: 30, motif: 'Contrôle glaucome', statut: 'complete', notes: '' },
  ...
  { id: 5, patient_id: 5, patient_nom: 'Moreau', patient_prenom: 'Claire', patient_telephone: '07 44 55 66 77', date: '2026-06-18', heure: '11:00', duree: 30, motif: 'Suivi post-op', statut: 'complete', notes: '' },
  { id: 6, patient_id: 6, patient_nom: 'Durand', patient_prenom: 'Paul', patient_telephone: '06 33 22 11 00', date: '2026-06-19', heure: '09:00', duree: 30, motif: 'Surveillance DMLA', statut: 'complete', notes: '' },
