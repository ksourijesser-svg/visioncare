...
export default function LandingPage() {
  return (
    <div className="min-h-screen text-[#1A2B3C]">
      ...
      {/* ── Navigation — floating pill w/ two-tone glow (cyan + violet) ─────── */}
        ...
        <div className="max-w-6xl mx-auto relative">
          ...
          <div className="rounded-full p-[1.5px] bg-gradient-to-r from-[#5EC8D8]/55 via-white/10 to-[#A78BFA]/55 shadow-[0_10px_40px_-8px_rgba(0,0,0,0.6)]">
            <div className="relative rounded-full bg-[#0A1525]/85 backdrop-blur-xl px-5 h-14 flex items-center justify-between overflow-hidden">
              ...
              <div className="flex items-center gap-2.5">
                <Link href="/prise-rdv" className="hidden md:inline-flex items-center gap-1.5 text-sm font-semibold border border-[#5EC8D8]/40 hover:border-[#5EC8D8] text-[#70B1C4] hover:text-white px-4 py-2 rounded-full hover:bg-[#5EC8D8]/15 transition-all duration-200">
        ...
        <div className="max-w-6xl mx-auto relative">
          ...
          <div className="absolute right-0 top-1/2 -translate-y-1/2 w-[460px] h-[460px] hidden lg:block">
            ...
            <div className="absolute inset-0 -z-10 pointer-events-none">
              {/* outer halo — tight around the eye */}
              <div
                className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[520px] h-[520px] rounded-full blur-[70px]"
                style={{ background: 'radial-gradient(circle, rgba(94,200,216,0.65) 0%, rgba(61,143,168,0.30) 45%, transparent 68%)' }}
              />
              {/* mid glow */}
              <div
                className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] rounded-full blur-[50px] animate-[pulse-glow_5s_ease-in-out_infinite]"
                style={{ background: 'radial-gradient(circle, rgba(112,177,196,0.80) 0%, rgba(94,200,216,0.35) 50%, transparent 70%)' }}
              />
              {/* bright core right behind the eye */}
              <div
                className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[260px] h-[260px] rounded-full blur-[35px]"
                style={{ background: 'radial-gradient(circle, rgba(180,235,245,0.80) 0%, rgba(94,200,216,0.50) 45%, transparent 70%)' }}
              />
            </div>
      ...
      <section className="py-20 bg-white border-b border-gray-100">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6 items-stretch text-center">
            ...
            <div className="flex flex-col items-center gap-6 bg-[#EEF7FC] rounded-3xl p-8 border-2 border-[#3d8fa8]/40 shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300 relative">
