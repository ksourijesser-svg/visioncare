      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#060F1E]/85 backdrop-blur-md border-b border-white/8">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <Link href="/prise-rdv" className="hidden md:inline-flex items-center gap-1.5 text-sm font-semibold border border-[#3d8fa8]/50 hover:border-[#3d8fa8] text-[#70B1C4] hover:text-white px-4 py-2 rounded-xl transition-all hover:bg-[#3d8fa8]/15">
