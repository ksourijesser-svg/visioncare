            ...
            <CardContent className="p-6 space-y-5">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1">
                  ...
                  <Input {...register('prenom')} className="border-0 dark:bg-[#0A1628] dark:text-[#E2EDF5]" />
                ...
                <div className="space-y-1">
                  ...
                  <Input {...register('nom')} className="border-0 dark:bg-[#0A1628] dark:text-[#E2EDF5]" />
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1">
                  ...
                  <Input {...register('email')} type="email" className="border-0 dark:bg-[#0A1628] dark:text-[#E2EDF5]" />
                ...
                <div className="space-y-1">
                  ...
                  <Input {...register('telephone')} className="border-0 dark:bg-[#0A1628] dark:text-[#E2EDF5]" placeholder="+33 6 00 00 00 00" />
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1">
                  ...
                  <Input {...register('specialite')} className="border-0 dark:bg-[#0A1628] dark:text-[#E2EDF5]" placeholder="Ophtalmologue" />
                </div>
                <div className="space-y-1">
                  <Label className="text-xs text-gray-500 dark:text-[#6A8E9F] flex items-center gap-1">
                    <ShieldCheck size={11} /> N° RPPS
                  </Label>
                  <Input {...register('rpps')} className="border-0 dark:bg-[#0A1628] dark:text-[#E2EDF5]" placeholder="10 chiffres" />
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-0 dark:bg-[#102844] glow">
            <CardContent className="p-6 space-y-5">
              ...
              <div className="space-y-1">
                ...
                <Input {...register('cabinet_nom')} className="border-0 dark:bg-[#0A1628] dark:text-[#E2EDF5]" placeholder="Cabinet VisionCare" />
              ...
              <div className="space-y-1">
                ...
                <Input {...register('cabinet_adresse')} className="border-0 dark:bg-[#0A1628] dark:text-[#E2EDF5]" placeholder="12 rue de la Santé, 75014 Paris" />
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1">
                  ...
                  <Input {...register('cabinet_telephone')} className="border-0 dark:bg-[#0A1628] dark:text-[#E2EDF5]" placeholder="01 00 00 00 00" />
                </div>
                <div className="space-y-1">
                  <Label className="text-xs text-gray-500 dark:text-[#6A8E9F] flex items-center gap-1">
                    <Mail size={11} /> Email du cabinet
                  </Label>
                  <Input {...register('cabinet_email')} type="email" className="border-0 dark:bg-[#0A1628] dark:text-[#E2EDF5]" placeholder="contact@cabinet.fr" />
              ...
              <div className="space-y-1">
                ...
                <Input {...register('cabinet_site')} className="border-0 dark:bg-[#0A1628] dark:text-[#E2EDF5]" placeholder="https://www.moncabinet.fr" />
              </div>
            </CardContent>
          </Card>
